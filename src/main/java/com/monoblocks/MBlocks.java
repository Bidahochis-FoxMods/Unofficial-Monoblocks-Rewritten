...
public class MBlocks {
   ...
   public static void registerBlocks()
   {
     ...
     // GameRegistry.registerBlock(Plastic, PlasticItem.class, "colorplastic");
      ...
      GameRegistry.registerBlock(Pole1, ScrollingItemBlock.class, "powerpole1");
      GameRegistry.registerBlock(Pole2, ScrollingItemBlock.class, "powerpole2");
      GameRegistry.registerBlock(Pole3, ScrollingItemBlock.class, "powerpole3");
      GameRegistry.registerBlock(Pole4, ScrollingItemBlock.class, "powerpole4");
      GameRegistry.registerBlock(Pole5, ScrollingItemBlock.class, "powerpole5");
      GameRegistry.registerBlock(Pole6, ScrollingItemBlock.class, "powerpole6");
      GameRegistry.registerBlock(Pole7, ScrollingItemBlock.class, "powerpole7");
      GameRegistry.registerBlock(Pole8, ScrollingItemBlock.class, "powerpole8");
      GameRegistry.registerBlock(Pole9, ScrollingItemBlock.class, "powerpole9");
      GameRegistry.registerBlock(Pole10, ScrollingItemBlock.class, "powerpole10");
      GameRegistry.registerBlock(Pole11, ScrollingItemBlock.class, "powerpole11");
      GameRegistry.registerBlock(Pole12, ScrollingItemBlock.class, "powerpole12");
      GameRegistry.registerBlock(Pole13, ScrollingItemBlock.class, "powerpole13");
      GameRegistry.registerBlock(Pole14, ScrollingItemBlock.class, "powerpole14");
     ...
     // GameRegistry.registerBlock(DarkStoneBrick, "darkstonebrick");
      ...
      GameRegistry.registerBlock(PowerPole15, ScrollingItemBlock.class, "powerpole15");
      GameRegistry.registerBlock(PowerPole16, ScrollingItemBlock.class, "powerpole16");
      ...
      GameRegistry.registerBlock(PowerPole17, ScrollingItemBlock.class, "powerpole17");
      GameRegistry.registerBlock(PowerPole18, ScrollingItemBlock.class, "powerpole18");
