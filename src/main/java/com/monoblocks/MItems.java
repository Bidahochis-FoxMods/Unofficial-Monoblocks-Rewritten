...
public class MItems {
   ...
   public static void registerItems() {
      DiamondDoorItem = (new DiamondDoorItem()).setCreativeTab(Monoblocks.monoblocksDoors);
      GoldenDoorItem = (new GoldenDoorItem()).setCreativeTab(Monoblocks.monoblocksDoors);
      ...
      Lighter = new Lighter();
      Bullet = (new Item()).setTextureName("monoblocks:bullet").setUnlocalizedName("bullet").setCreativeTab(Monoblocks.monoblocksitems);
      CD = (new Item()).setTextureName("monoblocks:cd").setUnlocalizedName("cd");
      GlassDoorItem = (new GlassDoorItem()).setCreativeTab(Monoblocks.monoblocksDoors);
      BlackDoorItem = (new BlackDoorItem()).setCreativeTab(Monoblocks.monoblocksDoors);
      BlueDoorItem = (new BlueDoorItem()).setCreativeTab(Monoblocks.monoblocksDoors);
      BrownDoorItem = (new BrownDoorItem()).setCreativeTab(Monoblocks.monoblocksDoors);
      CyanDoorItem = (new CyanDoorItem()).setCreativeTab(Monoblocks.monoblocksDoors);
      GrayDoorItem = (new GrayDoorItem()).setCreativeTab(Monoblocks.monoblocksDoors);
      GreenDoorItem = (new GreenDoorItem()).setCreativeTab(Monoblocks.monoblocksDoors);
      LblueDoorItem = (new LblueDoorItem()).setCreativeTab(Monoblocks.monoblocksDoors);
      LgrayDoorItem = (new LgrayDoorItem()).setCreativeTab(Monoblocks.monoblocksDoors);
      LimeDoorItem = (new LimeDoorItem()).setCreativeTab(Monoblocks.monoblocksDoors);
      MagentaDoorItem = (new MagentaDoorItem()).setCreativeTab(Monoblocks.monoblocksDoors);
      OrangeDoorItem = (new OrangeDoorItem()).setCreativeTab(Monoblocks.monoblocksDoors);
      PinkDoorItem = (new PinkDoorItem()).setCreativeTab(Monoblocks.monoblocksDoors);
      PurpleDoorItem = (new PurpleDoorItem()).setCreativeTab(Monoblocks.monoblocksDoors);
      RedDoorItem = (new RedDoorItem()).setCreativeTab(Monoblocks.monoblocksDoors);
      WhiteDoorItem = (new WhiteDoorItem()).setCreativeTab(Monoblocks.monoblocksDoors);
      YellowDoorItem = (new YellowDoorItem()).setCreativeTab(Monoblocks.monoblocksDoors);
      ...
      PointlessItem = (new PlasticChunk()).setCreativeTab(Monoblocks.monoblocksitems);
      RedSword = (new RedSword(5061, ToolMaterial.WOOD)).setCreativeTab(Monoblocks.monoblocksweapons);
      BlueSword = (new BlueSword(5062, ToolMaterial.WOOD)).setCreativeTab(Monoblocks.monoblocksweapons);
      RedLightSaber = (new RedLightSaber(5063, ToolMaterial.EMERALD)).setCreativeTab(Monoblocks.monoblocksweapons);
      BlueLightSaber = (new BlueLightSaber(5064, ToolMaterial.EMERALD)).setCreativeTab(Monoblocks.monoblocksweapons);
      Blaster = (new Blaster()).setCreativeTab(Monoblocks.monoblocksweapons);
      PinkGun = (new PinkGun()).setCreativeTab(Monoblocks.monoblocksweapons);
      RedCrystal = (new RedCrystal(5065)).setCreativeTab(Monoblocks.monoblocksitems);
      GreenLightsaber = (new GreenLightsaber(5066, ToolMaterial.EMERALD)).setCreativeTab(Monoblocks.monoblocksweapons);
      PurpleCrystal = (new PurpleCrystal(5067)).setCreativeTab(Monoblocks.monoblocksitems);
      PurpleLightsaber = (new PurpleLightsaber(5068, ToolMaterial.EMERALD)).setCreativeTab(Monoblocks.monoblocksweapons);
      FleshDye = (new FleshDye(5069)).setCreativeTab(Monoblocks.monoblocksitems);
      RainbowDye = (new RainbowDye(5060)).setCreativeTab(Monoblocks.monoblocksitems);
      InvisibleDye = (new InvisibleDye(5061)).setCreativeTab(Monoblocks.monoblocksitems);
      MudBall = new MudBall();
      ...
      MagicBigMac = (new MagicBigMac(5065)).setCreativeTab(Monoblocks.monoblocksitems);
      Fries = new Fries(5056, 5, true);
      SiftingSheet = (new SiftingSheet(5066)).setCreativeTab(Monoblocks.monoblocksitems);
      Record = new Record((String)null);
      IronSiftingSheet = (new IronSiftingSheet(5067)).setCreativeTab(Monoblocks.monoblocksitems);
      IronStick = (new IronStick(5068)).setCreativeTab(Monoblocks.monoblocksitems);
      SilverIngot = (new SilverIngot(5069)).setCreativeTab(Monoblocks.monoblocksitems);
      ZincIngot = (new ZincIngot(5070)).setCreativeTab(Monoblocks.monoblocksitems);
      CopperIngot = (new CopperIngot(5071)).setCreativeTab(Monoblocks.monoblocksitems);
      SteelIngot = (new SteelIngot(5072)).setCreativeTab(Monoblocks.monoblocksitems);
      AluminumIngot = (new AluminumIngot(5073)).setCreativeTab(Monoblocks.monoblocksitems);
      SteelSword = (new SteelSword(5074, ToolMaterial.EMERALD)).setCreativeTab(Monoblocks.monoblocksweapons);
      AluminumSword = (new AluminumSword(5075, ToolMaterial.STONE)).setCreativeTab(Monoblocks.monoblocksweapons);
      ZincSword = (new ZincSword(5076, ToolMaterial.WOOD)).setCreativeTab(Monoblocks.monoblocksweapons);
      CopperSword = (new CopperSword(5077, ToolMaterial.IRON)).setCreativeTab(Monoblocks.monoblocksweapons);
      SilverSword = (new SilverSword(5078, ToolMaterial.IRON)).setCreativeTab(Monoblocks.monoblocksweapons);
      SteelAxe = (new SteelAxe(5079, ToolMaterial.EMERALD)).setCreativeTab(Monoblocks.monoblocksweapons);
      AluminumAxe = (new AluminumAxe(5080, ToolMaterial.STONE)).setCreativeTab(Monoblocks.monoblocksweapons);
      ZincAxe = (new ZincAxe(5081, ToolMaterial.WOOD)).setCreativeTab(Monoblocks.monoblocksweapons);
      CopperAxe = (new CopperAxe(5082, ToolMaterial.IRON)).setCreativeTab(Monoblocks.monoblocksweapons);
      SilverAxe = (new SilverAxe(5083, ToolMaterial.IRON)).setCreativeTab(Monoblocks.monoblocksweapons);
      SteelHoe = (new SteelHoe(5084, ToolMaterial.EMERALD)).setCreativeTab(Monoblocks.monoblocksweapons);
      AluminumHoe = (new AluminumHoe(5085, ToolMaterial.STONE)).setCreativeTab(Monoblocks.monoblocksweapons);
      ZincHoe = (new ZincHoe(5086, ToolMaterial.WOOD)).setCreativeTab(Monoblocks.monoblocksweapons);
      CopperHoe = (new CopperHoe(5087, ToolMaterial.IRON)).setCreativeTab(Monoblocks.monoblocksweapons);
      SilverHoe = (new SilverHoe(5088, ToolMaterial.IRON)).setCreativeTab(Monoblocks.monoblocksweapons);
      SteelSword = (new SteelSword(5089, ToolMaterial.EMERALD)).setCreativeTab(Monoblocks.monoblocksweapons);
      AluminumSword = (new AluminumSword(5090, ToolMaterial.STONE)).setCreativeTab(Monoblocks.monoblocksweapons);
      ZincSword = (new ZincSword(5091, ToolMaterial.WOOD)).setCreativeTab(Monoblocks.monoblocksweapons);
      CopperSword = (new CopperSword(5092, ToolMaterial.IRON)).setCreativeTab(Monoblocks.monoblocksweapons);
      SilverSword = (new SilverSword(5093, ToolMaterial.IRON)).setCreativeTab(Monoblocks.monoblocksweapons);
      SteelShovel = (new SteelShovel(5089, ToolMaterial.EMERALD)).setCreativeTab(Monoblocks.monoblocksweapons);
      AluminumShovel = (new AluminumShovel(5090, ToolMaterial.STONE)).setCreativeTab(Monoblocks.monoblocksweapons);
      ZincShovel = (new ZincShovel(5091, ToolMaterial.WOOD)).setCreativeTab(Monoblocks.monoblocksweapons);
      CopperShovel = (new CopperShovel(5092, ToolMaterial.IRON)).setCreativeTab(Monoblocks.monoblocksweapons);
      SilverShovel = (new SilverShovel(5093, ToolMaterial.IRON)).setCreativeTab(Monoblocks.monoblocksweapons);
      SteelPickaxe = (new SteelPickaxe(5089, ToolMaterial.EMERALD)).setCreativeTab(Monoblocks.monoblocksweapons);
      AluminumPickaxe = (new AluminumPickaxe(5090, ToolMaterial.STONE)).setCreativeTab(Monoblocks.monoblocksweapons);
      ZincPickaxe = (new ZincPickaxe(5091, ToolMaterial.WOOD)).setCreativeTab(Monoblocks.monoblocksweapons);
      CopperPickaxe = (new CopperPickaxe(5092, ToolMaterial.IRON)).setCreativeTab(Monoblocks.monoblocksweapons);
      SilverPickaxe = (new SilverPickaxe(5093, ToolMaterial.IRON)).setCreativeTab(Monoblocks.monoblocksweapons);
      SpawnEgg = (new MobPlacer()).setUnlocalizedName("spawnegg");
