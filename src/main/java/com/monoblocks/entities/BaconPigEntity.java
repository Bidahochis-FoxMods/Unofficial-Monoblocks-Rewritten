...
public class BaconPigEntity extends EntityAnimal {
   ...
   public BaconPigEntity(World p_i1689_1_) {
      ...
      this.field_70714_bg.func_75776_a(2, this.aiControlledByPlayer = new EntityAIControlledByPlayer(this, 0.3F));
   ...
   public void func_70014_b(NBTTagCompound p_70014_1_) {
      ...
      p_70014_1_.func_74757_a("Saddle", this.getSaddled());
   }

   public void func_70037_a(NBTTagCompound p_70037_1_) {
      super.func_70037_a(p_70037_1_);
      this.setSaddled(p_70037_1_.func_74767_n("Saddle"));
   }
   ...
   public boolean func_70085_c(EntityPlayer p_70085_1_) {
      if (super.func_70085_c(p_70085_1_)) {
         return true;
      } else if (!this.getSaddled() || this.field_70170_p.field_72995_K || this.field_70153_n != null && this.field_70153_n != p_70085_1_) {
         return false;
      } else {
   ...
   protected void func_70628_a(boolean p_70628_1_, int p_70628_2_) {
      ...
      for(int k = 0; k < j; ++k) {
         if (this.func_70027_ad()) {
            ...
            this.func_145779_a(MItems.Bacon, 16);
         }
      }
   ...
   public BaconPigEntity createChild(EntityAgeable p_90011_1_) {
      return new BaconPigEntity(this.field_70170_p);
   }
