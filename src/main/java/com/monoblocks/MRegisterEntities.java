...
public class MRegisterEntities
{
   public MRegisterEntities()
   {
      ...
      EntityRegistry.registerModEntity(BaconPigEntity.class, "Baconpig", 1, Monoblocks.instance, 80, 5, true);
      EntityRegistry.addSpawn(BaconPigEntity.class, 5, 8, 12, EnumCreatureType.creature, forest);
   }
}
