...
public class GuiBlueNameSign extends GuiScreen {
   private TileEntityBlueNameSign sign;
   private float bgColR = 1.0F;
   private float bgColG = 1.0F;
   private float bgColB = 1.0F;
   private static ResourceLocation background = new ResourceLocation("monoblocks:textures/gui/guibluenamesign.png");
   private String[] text = new String[]{""};
   int currentLine = 0;

   public GuiBlueNameSign(TileEntityBlueNameSign logic) {
      this.sign = logic;
   }
