...
public class GuiGreenNameSign extends GuiScreen {
   private TileEntityGreenNameSign sign;
   private float bgColR = 1.0F;
   private float bgColG = 1.0F;
   private float bgColB = 1.0F;
   private static ResourceLocation background = new ResourceLocation("monoblocks:textures/gui/guigreennamesign.png");
   private String[] text = new String[]{""};
   int currentLine = 0;

   public GuiGreenNameSign(TileEntityGreenNameSign logic) {
      this.sign = logic;
   }
