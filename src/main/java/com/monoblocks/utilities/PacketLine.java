...
@Sharable
public class PacketLine extends MessageToMessageCodec<FMLProxyPacket, AbstractPacket> {
   ...
   public void initalise() {
      this.channels = NetworkRegistry.INSTANCE.newChannel("Monoblocks", new ChannelHandler[]{this});
      this.registerPackets();
   }

   public void registerPackets() {
      this.registerPacket(SignDataPacket.class);
   }
