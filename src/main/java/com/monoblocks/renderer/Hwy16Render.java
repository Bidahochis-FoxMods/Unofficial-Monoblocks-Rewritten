...
public class Hwy16Render extends TileEntitySpecialRenderer {
   private Sign model = new Sign();

   public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
      TileEntityHwy16 stopSign = (TileEntityHwy16)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/signage/Hwy16Model.png");
