...
import com.monoblocks.blocks.models.InsulatorModel17;
...
public class PowerPole14Render extends TileEntitySpecialRenderer {
   private InsulatorModel17 model = new InsulatorModel17();

   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityPowerPole14 stopSign = (TileEntityPowerPole14)te;
