...
public class TrafficLightLeftArrowRender extends TileEntitySpecialRenderer {
   ...
   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityTrafficLightLeftArrow stopSign = (TileEntityTrafficLightLeftArrow)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/model/stoplightleftarrow.png");
