...
import com.monoblocks.blocks.models.InsulatorModel18;
...
public class PowerPole17Render extends TileEntitySpecialRenderer {
   private InsulatorModel18 model = new InsulatorModel18();

   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityPowerPole17 stopSign = (TileEntityPowerPole17)te;
