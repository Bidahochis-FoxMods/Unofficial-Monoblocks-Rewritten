...
public class PurpleLampRender extends TileEntitySpecialRenderer {
   private ModelGlow model = new ModelGlow();

   public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
      TileEntityPurpleLamp stopSign = (TileEntityPurpleLamp)te;
      GL11.glPushMatrix();
      ...
      GL11.glColor4f(0.6F, 0.0F, 1.0F, 0.35F);
