...
public class TrainCrossingRender extends TileEntitySpecialRenderer {
   private Sign model = new Sign();

   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityTrainCrossing stopSign = (TileEntityTrainCrossing)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/signage/TrainCrossingAhead.png");
