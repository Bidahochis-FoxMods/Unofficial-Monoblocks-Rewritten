...
public class TrafficLightRightArrowRender extends TileEntitySpecialRenderer {
   ...
   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityTrafficLightRightArrow stopSign = (TileEntityTrafficLightRightArrow)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/model/stoplightrightarrow.png");
