...
import com.monoblocks.blocks.models.FryerModel;
...
public class FryerRenderer extends TileEntitySpecialRenderer {
   private FryerModel model = new FryerModel();

   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityFryer stopSign = (TileEntityFryer)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/model/Fryer.png");
