...
public class MagentaLampRender extends TileEntitySpecialRenderer {
   private ModelGlow model = new ModelGlow();

   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityMagentaLamp stopSign = (TileEntityMagentaLamp)te;
      GL11.glPushMatrix();
      ...
      GL11.glColor4f(1.0F, 0.0F, 1.0F, 0.35F);
