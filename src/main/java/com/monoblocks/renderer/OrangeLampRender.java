...
public class OrangeLampRender extends TileEntitySpecialRenderer {
   private ModelGlow model = new ModelGlow();

   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityOrangeLamp stopSign = (TileEntityOrangeLamp)te;
      GL11.glPushMatrix();
      ...
      GL11.glColor4f(1.0F, 0.61F, 0.0F, 0.35F);
