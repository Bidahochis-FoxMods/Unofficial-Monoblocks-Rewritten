...
public class LitteringPenaltyRender extends TileEntitySpecialRenderer {
   private Sign model = new Sign();

   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityLittering stopSign = (TileEntityLittering)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/signage/LitterPenalty.png");
