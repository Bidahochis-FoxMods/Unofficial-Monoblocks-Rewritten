...
public class StoplightPoleAttachmentRender extends TileEntitySpecialRenderer {
   ...
   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityStoplightPoleAttachment stopSign = (TileEntityStoplightPoleAttachment)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/model/stoplightwithstick.png");
