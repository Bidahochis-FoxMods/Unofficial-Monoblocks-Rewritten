...
import com.monoblocks.blocks.models.StereoModel;
...
public class StereoRender extends TileEntitySpecialRenderer {
   private StereoModel model = new StereoModel();

   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityStereo stopSign = (TileEntityStereo)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/model/stereo.png");
