...
public class Hwy99Render extends TileEntitySpecialRenderer {
   private Sign model = new Sign();

   public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
      TileEntityHwySign99 stopSign = (TileEntityHwySign99)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/signage/Hwy99Model.png");
