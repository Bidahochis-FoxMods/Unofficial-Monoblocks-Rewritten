...
public class Hwy21Render extends TileEntitySpecialRenderer {
   private Sign model = new Sign();

   public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
      TileEntityHwySign21 stopSign = (TileEntityHwySign21)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/signage/Hwy21Model.png");
