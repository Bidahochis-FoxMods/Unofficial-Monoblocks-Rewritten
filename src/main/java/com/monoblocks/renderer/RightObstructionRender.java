...
public class RightObstructionRender extends TileEntitySpecialRenderer {
   private Sign model = new Sign();

   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityRightObstruction stopSign = (TileEntityRightObstruction)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/signage/rightobstruction.png");
