...
public class Hwy39Render extends TileEntitySpecialRenderer {
   ...
   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/signage/Hwy39Model.png");
