...
import com.monoblocks.blocks.models.ModelDoubleStreetLight;
...
public class DoubleStreetLightRender extends TileEntitySpecialRenderer {
   private ModelDoubleStreetLight model = new ModelDoubleStreetLight();

   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityDoubleStreetLight stopSign = (TileEntityDoubleStreetLight)te;
