...
public class StoplightStickRightArrowRender extends TileEntitySpecialRenderer {
   ...
   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityTrafficLightStickRightArrow stopSign = (TileEntityTrafficLightStickRightArrow)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/model/stoplightstickrightarrow.png");
