...
import com.monoblocks.blocks.models.Insulator1;
...
public class Insulator1Render extends TileEntitySpecialRenderer {
   private Insulator1 model = new Insulator1();

   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityInsulator1 stopSign = (TileEntityInsulator1)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/model/InsulatorModel9.png");
