...
public class LeftAddedLaneRender extends TileEntitySpecialRenderer {
   private Sign model = new Sign();

   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityLeftAddedLane stopSign = (TileEntityLeftAddedLane)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/signage/leftaddedlanemodel.png");
