...
public class VariableSpeedSignFRender extends TileEntitySpecialRenderer {
   private SignNoPost model = new SignNoPost();

   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityVariableSpeedSignF stopSign = (TileEntityVariableSpeedSignF)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/signage/v80kmModel.png");
