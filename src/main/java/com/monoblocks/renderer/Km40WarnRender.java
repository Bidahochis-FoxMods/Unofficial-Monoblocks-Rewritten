...
public class Km40WarnRender extends TileEntitySpecialRenderer {
   private Sign model = new Sign();

   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityKm40Warn stopSign = (TileEntityKm40Warn)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/signage/40kmwarnmodel.png");
