...
import com.monoblocks.blocks.models.InsulatorModel5;
...
public class PowerPole10Render extends TileEntitySpecialRenderer {
   private InsulatorModel5 model = new InsulatorModel5();

   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityPowerPole10 stopSign = (TileEntityPowerPole10)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/model/InsulatorModel12.png");
