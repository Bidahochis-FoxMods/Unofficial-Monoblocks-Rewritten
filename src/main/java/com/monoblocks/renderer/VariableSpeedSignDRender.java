...
public class VariableSpeedSignDRender extends TileEntitySpecialRenderer {
   private SignNoPost model = new SignNoPost();

   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityVariableSpeedSignD stopSign = (TileEntityVariableSpeedSignD)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/signage/v60kmModel.png");
