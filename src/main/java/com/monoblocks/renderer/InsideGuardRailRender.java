...
import com.monoblocks.blocks.models.InsideGuardRail;
...
public class InsideGuardRailRender extends TileEntitySpecialRenderer {
   private InsideGuardRail model = new InsideGuardRail();

   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityInsideGuardRail stopSign = (TileEntityInsideGuardRail)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/model/cornerguardrail.png");
      Minecraft.func_71410_x().field_71446_o.func_110577_a(textures);
      GL11.glPushMatrix();
      GL11.glRotatef(180.0F, 270.0F, 0.0F, 0.0F);
