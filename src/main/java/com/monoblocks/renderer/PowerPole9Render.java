...
public class PowerPole9Render extends TileEntitySpecialRenderer {
   ...
   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityPowerPole9 stopSign = (TileEntityPowerPole9)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/model/InsulatorModel11.png");
