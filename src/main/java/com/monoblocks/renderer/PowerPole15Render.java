...
import com.monoblocks.blocks.models.InsulatorModel9;
...
public class PowerPole15Render extends TileEntitySpecialRenderer {
   private InsulatorModel9 model = new InsulatorModel9();

   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityPowerPole15 stopSign = (TileEntityPowerPole15)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/model/InsulatorModel17.png");
