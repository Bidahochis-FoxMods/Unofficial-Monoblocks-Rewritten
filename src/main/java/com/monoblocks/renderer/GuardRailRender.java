...
import com.monoblocks.blocks.models.ModelGuardRail;
...
public class GuardRailRender extends TileEntitySpecialRenderer {
   private ModelGuardRail model = new ModelGuardRail();

   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityGuardRail stopSign = (TileEntityGuardRail)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/model/GuardRail.png");
