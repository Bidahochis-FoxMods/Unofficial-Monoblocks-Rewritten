...
public class Hwy2Render extends TileEntitySpecialRenderer {
   private Sign model = new Sign();

   public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
      TileEntityHwySign2 stopSign = (TileEntityHwySign2)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/signage/Hwy2Model.png");
