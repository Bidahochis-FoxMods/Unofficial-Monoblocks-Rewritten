...
import com.monoblocks.blocks.models.GateOpenModel;
...
public class GateRender extends TileEntitySpecialRenderer {
   private GateOpenModel model = new GateOpenModel();

   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityGate stopSign = (TileEntityGate)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/model/gateopen.png");
