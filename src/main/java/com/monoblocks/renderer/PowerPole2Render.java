...
import com.monoblocks.blocks.models.InsulatorModel2;
...
public class PowerPole2Render extends TileEntitySpecialRenderer {
   private InsulatorModel2 model = new InsulatorModel2();

   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityPowerPole2 stopSign = (TileEntityPowerPole2)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/model/InsulatorModel2.png");
