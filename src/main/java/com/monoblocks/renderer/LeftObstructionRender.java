...
public class LeftObstructionRender extends TileEntitySpecialRenderer {
   private Sign model = new Sign();

   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityLeftObstruction stopSign = (TileEntityLeftObstruction)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/signage/leftobstruction.png");
