...
import com.monoblocks.blocks.models.Insulator2;
...
public class Insulator2Render extends TileEntitySpecialRenderer {
   private Insulator2 model = new Insulator2();

   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityInsulator2 stopSign = (TileEntityInsulator2)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/model/InsulatorModel10.png");
