...
public class NoRightTurnRender extends TileEntitySpecialRenderer {
   private Sign model = new Sign();

   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      TileEntityNoRightTurn stopSign = (TileEntityNoRightTurn)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/signage/NoRightTurnModel.png");
