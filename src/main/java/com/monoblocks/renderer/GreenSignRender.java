...
public class GreenSignRender extends TileEntitySignRenderer {
   private Sign model = new Sign();

   public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
      TileEntityGreenSign sign = (TileEntityGreenSign)te;
      ...
      ResourceLocation textures = new ResourceLocation("monoblocks:textures/signage/GreenInfoModel.png");
