...
public class StraightSign extends BlockContainer {
   public StraightSign() {
      super(Material.iron);
      this.setCreativeTab(Monoblocks.monoblocksSignage);
      this.setHardness(2.0F);
      this.setBlockBounds(0.34F, 0.0F, 0.34F, 0.66F, 1.0F, 0.66F);
      this.setBlockName("Straight Sign");
   }

   @SideOnly(Side.CLIENT)
   public void func_149651_a(IIconRegister iconRegister) {
      this.blockIcon = iconRegister.registerIcon("monoblocks:straight");
   }
