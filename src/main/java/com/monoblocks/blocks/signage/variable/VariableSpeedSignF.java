...
public class VariableSpeedSignF extends BlockContainer {
   ...
   public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9) {
      par1World.setBlock(par2, par3, par4, MBlocks.VariableSpeedSignG, par1World.getBlockMetadata(par2, par3, par4), 3);
      return true;
   }
   ...
   public void updateTick(World world, int x, int y, int z, Random random) {
      if (!world.isRemote) {
         world.setBlock(x, y, z, MBlocks.VariableSpeedSignF, world.getBlockMetadata(x, y, z), 2);
      }
