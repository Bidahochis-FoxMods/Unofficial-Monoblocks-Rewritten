...
public class VariableSpeedSignD extends BlockContainer {
   @SideOnly(Side.CLIENT)
   private IIcon[] texture;

   public VariableSpeedSignD() {
      super(Material.wood);
   ...
   public boolean func_149727_a(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9) {
      par1World.func_147465_d(par2, par3, par4, MBlocks.VariableSpeedSignE, par1World.func_72805_g(par2, par3, par4), 3);
      return true;
   }
   ...
   public void func_149651_a(IIconRegister iconRegister) {
      this.blockIcon = iconRegister.registerIcon("monoblocks:60vkmh");
   }

   public void func_149674_a(World world, int x, int y, int z, Random random) {
      if (!world.field_72995_K) {
         world.func_147465_d(x, y, z, MBlocks.VariableSpeedSignD, world.func_72805_g(x, y, z), 2);
      }
   ...
   public TileEntity func_149915_a(World world, int meta) {
      return (TileEntity)(!world.field_72995_K ? new TileEntityVariableSpeedSignD() : new TileEntityVariableSpeedSignE());
   }
