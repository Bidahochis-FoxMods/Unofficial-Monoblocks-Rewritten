...
public class KmSignCNoPost extends BlockContainer {
   public KmSignCNoPost() {
      super(Material.iron);
      this.setCreativeTab(Monoblocks.monoblocksTab);
      this.setHardness(2.0F);
      this.setBlockBounds(0.34F, 0.0F, 0.34F, 0.66F, 1.0F, 0.66F);
      this.setBlockName("kmsign80nopost");
   }
   ...
   public void func_149651_a(IIconRegister iconRegister) {
      this.blockIcon = iconRegister.registerIcon("monoblocks:80kmh");
   }
   ...
   public TileEntity func_149915_a(World world, int meta) {
      return new TileEntityKmSignCNoPost();
   }
