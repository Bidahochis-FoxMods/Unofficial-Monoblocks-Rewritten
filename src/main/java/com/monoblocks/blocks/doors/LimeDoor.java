...
public class LimeDoor extends BlockDoor {
   public IIcon[] icons;
   public IIcon[] iconsReverse;

   public LimeDoor(Material material) {
      super(material);
      float f = 0.5F;
      float f1 = 1.0F;
   ...
   public void registerBlockIcons(IIconRegister iconRegister) {
      ...
      this.icons[0] = iconRegister.registerIcon("monoblocks:glassdoorbottomlime");
      this.icons[1] = iconRegister.registerIcon("monoblocks:glassdoortoplime");
   ...
   public ItemStack getPickBlock(MovingObjectPosition target, World world, int x, int y, int z) {
      return new ItemStack(MItems.LimeDoorItem, 1);
   }
