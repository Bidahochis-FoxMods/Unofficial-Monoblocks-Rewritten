...
public class GlassDoor extends BlockDoor {
   ...
   public Item func_149650_a(int i, Random random, int j) {
      return (i & 8) != 0 ? Item.getItemFromBlock(Blocks.field_150350_a) : MItems.GlassDoorItem;
   }

   public void func_149651_a(IIconRegister iconRegister) {
      this.icons = new IIcon[2];
      this.icons[0] = iconRegister.registerIcon("monoblocks:glassdoorbottom");
      this.icons[1] = iconRegister.registerIcon("monoblocks:glassdoortop");
   ...
   public ItemStack getPickBlock(MovingObjectPosition target, World world, int x, int y, int z) {
      return new ItemStack(MItems.GlassDoorItem, 1);
   }
