...
public class CyanDoor extends BlockDoor {
   public IIcon[] icons;
   public IIcon[] iconsReverse;

   public CyanDoor(Material material) {
      super(material);
      float f = 0.5F;
      float f1 = 1.0F;
   ...
   public Item func_149650_a(int i, Random random, int j) {
      return (i & 8) != 0 ? Item.getItemFromBlock(Blocks.field_150350_a) : MItems.CyanDoorItem;
   }

   public void func_149651_a(IIconRegister iconRegister) {
      this.icons = new IIcon[2];
      this.icons[0] = iconRegister.registerIcon("monoblocks:glassdoorbottomcyan");
      this.icons[1] = iconRegister.registerIcon("monoblocks:glassdoortopcyan");
   ...
   public ItemStack getPickBlock(MovingObjectPosition target, World world, int x, int y, int z) {
      return new ItemStack(MItems.CyanDoorItem, 1);
   }
