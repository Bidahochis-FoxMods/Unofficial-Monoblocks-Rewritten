...
public class DiamondDoor extends BlockDoor {
   ...
   public DiamondDoor(Material material) {
      super(Material.iron);
      float f = 0.5F;
      float f1 = 1.0F;
   ...
   public void func_149651_a(IIconRegister iconRegister) {
      ...
      this.icons[0] = iconRegister.registerIcon("monoblocks:diamonddoorbottom");
      this.icons[1] = iconRegister.registerIcon("monoblocks:diamonddoortop");
   ...
   public ItemStack getPickBlock(MovingObjectPosition target, World world, int x, int y, int z) {
      return new ItemStack(MItems.DiamondDoorItem, 1);
   }
