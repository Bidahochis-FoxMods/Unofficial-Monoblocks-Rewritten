...
public class TileEntityIronFurnace extends TileEntity implements ISidedInventory {
   ...
   public String func_145825_b() {
      return this.func_145818_k_() ? this.localizedName : "Iron Furnace";
   }
   ...
   public void func_145845_h() {
      ...
      if (!this.field_145850_b.field_72995_K) {
         ...
         if (flag != this.isBurning()) {
            flag1 = true;
            IronFurnace.updateIronFurnaceBlockState(this.burnTime > 0, this.field_145850_b, this.field_145851_c, this.field_145848_d, this.field_145849_e);
         }
      }
