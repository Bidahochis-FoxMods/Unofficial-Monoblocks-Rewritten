...
public class TileEntityIronFurnace extends TileEntity implements ISidedInventory {
   ...
   public String getInventoryName() {
      return this.hasCustomInventoryName() ? this.localizedName : "Iron Furnace";
   }
   ...
   public void updateEntity() {
      ...
      if (!this.worldObj.isRemote) {
         ...
         if (flag != this.isBurning()) {
            flag1 = true;
            IronFurnace.updateIronFurnaceBlockState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
         }
      }
