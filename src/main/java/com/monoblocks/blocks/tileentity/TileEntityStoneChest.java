...
public class TileEntityStoneChest extends TileEntityChest {
   ...
   public String getInventoryName() {
      return this.hasCustomInventoryName() ? this.customName : "Stone Chest";
   }
   ...
   public void readFromNBT(NBTTagCompound p_145839_1_) {
      ...
      if (p_145839_1_.hasKey("Stone Chest", 8)) {
         this.customName = p_145839_1_.getString("Stone Chest");
      }
   ...
   public void writeToNBT(NBTTagCompound p_145841_1_) {
      ...
      if (this.hasCustomInventoryName()) {
         p_145841_1_.setString("Stone Chest", this.customName);
      }
   ...
   public void func_145979_i() {
      if (!this.adjacentChestChecked) {
         ...
         if (this.func_145977_a(this.xCoord - 1, this.yCoord, this.zCoord)) {
            this.field_145991_k = (TileEntityStoneChest)this.worldObj.getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
         }

         if (this.func_145977_a(this.xCoord + 1, this.yCoord, this.zCoord)) {
            this.field_145990_j = (TileEntityStoneChest)this.worldObj.getTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
         }

         if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord - 1)) {
            this.field_145992_i = (TileEntityStoneChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
         }

         if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord + 1)) {
            this.field_145988_l = (TileEntityStoneChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
         }
   ...
   public int func_145980_j() {
      if (this.cachedChestType == -1) {
         if (this.worldObj == null || !(this.getBlockType() instanceof StoneChest)) {
            return 0;
         }

         this.cachedChestType = ((StoneChest)this.getBlockType()).field_149956_a;
      }
