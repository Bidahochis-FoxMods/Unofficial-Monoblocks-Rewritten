...
public class TileEntityFryer extends TileEntity implements ISidedInventory {
   ...
   public String getInventoryName() {
      return this.hasCustomInventoryName() ? this.localizedName : "Fryer";
   }
   ...
   public void updateEntity() {
      ...
      if (!this.worldObj.isRemote) {
         ...
         if (flag != this.isBurning()) {
            flag1 = true;
            Fryer.updateFryerBlockState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
         }
      }
