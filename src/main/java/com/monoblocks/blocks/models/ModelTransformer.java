...
public class ModelTransformer extends ModelBase {
   ...
   public ModelTransformer() {
      ...
      this.Shape2.func_78793_a(-1.0F, 11.0F, 14.0F);
      ...
      this.Shape3.func_78793_a(-1.0F, 20.0F, 14.0F);
      this.Shape3.func_78787_b(64, 32);
      this.Shape3.field_78809_i = true;
      this.setRotation(this.Shape3, 0.0F, 1.570796F, 0.0F);
      this.Shape4 = new ModelRenderer(this, 0, 0);
      this.Shape4.func_78789_a(0.0F, 0.0F, 0.0F, 8, 16, 6);
      this.Shape4.func_78793_a(-3.0F, 8.0F, 12.0F);
      this.Shape4.func_78787_b(64, 32);
      this.Shape4.field_78809_i = true;
      this.setRotation(this.Shape4, 0.0F, 1.570796F, 0.0F);
      this.Shape5 = new ModelRenderer(this, 0, 0);
      this.Shape5.func_78789_a(0.0F, 0.0F, 0.0F, 6, 16, 8);
      this.Shape5.func_78793_a(-4.0F, 8.0F, 11.0F);
      this.Shape5.func_78787_b(64, 32);
      this.Shape5.field_78809_i = true;
      this.setRotation(this.Shape5, 0.0F, 1.570796F, 0.0F);
      this.Shape1 = new ModelRenderer(this, 0, 0);
      this.Shape1.func_78789_a(0.0F, 0.0F, 0.0F, 2, 3, 2);
      this.Shape1.func_78793_a(-1.0F, 5.0F, 8.0F);
      ...
      this.Shape6.func_78793_a(-0.5F, 4.0F, 7.5F);
