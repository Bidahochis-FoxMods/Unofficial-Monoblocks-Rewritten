...
public class InsulatorModel17 extends ModelBase {
   ...
   public InsulatorModel17() {
      this.field_78090_t = 128;
      this.field_78089_u = 64;
      this.Shape1 = new ModelRenderer(this, 0, 3);
      this.Shape1.func_78789_a(0.0F, 0.0F, 0.0F, 4, 9, 4);
      this.Shape1.func_78793_a(-2.0F, 15.0F, -2.0F);
      this.Shape1.func_78787_b(128, 64);
      this.Shape1.field_78809_i = true;
      this.setRotation(this.Shape1, 0.0F, 0.0F, 0.0F);
      this.Shape2 = new ModelRenderer(this, 0, 0);
      this.Shape2.func_78789_a(0.0F, 0.0F, 0.0F, 32, 2, 1);
      this.Shape2.func_78793_a(-16.0F, 8.0F, -0.6F);
      ...
      this.Shape3.func_78793_a(-7.0F, 10.0F, -0.5F);
      ...
      this.Shape4.func_78793_a(7.6F, 9.3F, -0.5F);
      ...
      this.Shape6.func_78793_a(-15.0F, 6.0F, -0.6F);
      ...
      this.Shape7.func_78793_a(14.0F, 6.0F, -0.6F);
      ...
      this.Shape11.func_78793_a(-1.0F, 6.0F, -1.1F);
      ...
      this.Shape12.func_78793_a(-15.5F, 6.0F, -1.1F);
      ...
      this.Shape13.func_78793_a(-0.5F, 5.0F, -0.6F);
      ...
      this.Shape14.func_78793_a(-15.0F, 5.0F, -0.6F);
      this.Shape14.func_78787_b(128, 64);
      this.Shape14.field_78809_i = true;
      this.setRotation(this.Shape14, 0.0F, 0.0F, 0.0F);
      this.Shape5 = new ModelRenderer(this, 69, 0);
      this.Shape5.func_78789_a(0.0F, 0.0F, 0.0F, 3, 1, 1);
      this.Shape5.func_78793_a(7.0F, 10.0F, -0.6F);
      this.Shape5.func_78787_b(128, 64);
      this.Shape5.field_78809_i = true;
      this.setRotation(this.Shape5, 0.0F, 0.0F, 0.0F);
      this.Shape17 = new ModelRenderer(this, 69, 0);
      this.Shape17.func_78789_a(0.0F, 0.0F, 0.0F, 3, 1, 1);
      this.Shape17.func_78793_a(-10.0F, 10.0F, -0.6F);
      ...
      this.Shape8.func_78793_a(2.0F, 15.0F, -0.6F);
      ...
      this.Shape9.func_78793_a(-3.0F, 15.0F, -0.6F);
      ...
      this.Shape10.func_78793_a(-0.5F, 6.0F, -0.6F);
      this.Shape10.func_78787_b(128, 64);
      this.Shape10.field_78809_i = true;
      this.setRotation(this.Shape10, 0.0F, 0.0F, 0.0F);
      this.Shape15 = new ModelRenderer(this, 20, 5);
      this.Shape15.func_78789_a(0.0F, 0.0F, 0.0F, 2, 1, 2);
      this.Shape15.func_78793_a(13.5F, 6.0F, -1.1F);
      this.Shape15.func_78787_b(128, 64);
      this.Shape15.field_78809_i = true;
      this.setRotation(this.Shape15, 0.0F, 0.0F, 0.0F);
      this.Shape16 = new ModelRenderer(this, 20, 11);
      this.Shape16.func_78789_a(0.0F, 0.0F, 0.0F, 1, 1, 1);
      this.Shape16.func_78793_a(14.0F, 5.0F, -0.6F);
