...
public class CurvedRail extends ModelBase {
   ...
   public CurvedRail() {
      ...
      this.Shape1.func_78789_a(0.0F, 0.0F, 0.0F, 2, 1, 1);
      ...
      this.Shape2.func_78793_a(5.0F, 22.0F, -8.0F);
      this.Shape2.func_78787_b(64, 32);
      this.Shape2.field_78809_i = true;
      this.setRotation(this.Shape2, 0.0F, 0.0F, 0.0F);
      this.Shape3 = new ModelRenderer(this, 0, 29);
      this.Shape3.func_78789_a(0.0F, 0.0F, 0.0F, 14, 1, 2);
      this.Shape3.func_78793_a(-4.0F, 23.0F, 2.35F);
      ...
      this.Shape4.func_78789_a(0.0F, 0.0F, 0.0F, 14, 1, 2);
      ...
      this.Shape5.func_78789_a(0.0F, 0.0F, 0.0F, 2, 1, 14);
      this.Shape5.func_78793_a(5.0F, 23.0F, -7.0F);
      this.Shape5.func_78787_b(64, 32);
      this.Shape5.field_78809_i = true;
      this.setRotation(this.Shape5, 0.0F, 0.0F, 0.0F);
      this.Shape6 = new ModelRenderer(this, 0, 0);
      this.Shape6.func_78789_a(0.0F, 0.0F, 0.0F, 4, 1, 1);
      this.Shape6.func_78793_a(4.0F, 22.0F, 5.0F);
      this.Shape6.func_78787_b(64, 32);
      this.Shape6.field_78809_i = true;
      this.setRotation(this.Shape6, 0.0F, 0.0F, 0.0F);
      this.Shape7 = new ModelRenderer(this, 0, 0);
      this.Shape7.func_78789_a(0.0F, 0.0F, 0.0F, 1, 1, 4);
      this.Shape7.func_78793_a(-6.0F, 22.0F, -8.0F);
      this.Shape7.func_78787_b(64, 32);
      this.Shape7.field_78809_i = true;
      this.setRotation(this.Shape7, 0.0F, 0.0F, 0.0F);
      this.Shape8 = new ModelRenderer(this, 0, 0);
      this.Shape8.func_78789_a(0.0F, 0.0F, 0.0F, 2, 1, 1);
      this.Shape8.func_78793_a(2.0F, 22.0F, 4.0F);
      this.Shape8.func_78787_b(64, 32);
      this.Shape8.field_78809_i = true;
      this.setRotation(this.Shape8, 0.0F, 0.0F, 0.0F);
      this.Shape9 = new ModelRenderer(this, 0, 0);
      this.Shape9.func_78789_a(0.0F, 0.0F, 0.0F, 1, 1, 2);
      this.Shape9.func_78793_a(-5.0F, 22.0F, -4.0F);
      this.Shape9.func_78787_b(64, 32);
      this.Shape9.field_78809_i = true;
      this.setRotation(this.Shape9, 0.0F, 0.0F, 0.0F);
      this.Shape10 = new ModelRenderer(this, 0, 0);
      this.Shape10.func_78789_a(0.0F, 0.0F, 0.0F, 2, 1, 1);
      this.Shape10.func_78793_a(0.0F, 22.0F, 3.0F);
      this.Shape10.func_78787_b(64, 32);
      this.Shape10.field_78809_i = true;
      this.setRotation(this.Shape10, 0.0F, 0.0F, 0.0F);
      this.Shape11 = new ModelRenderer(this, 0, 0);
      this.Shape11.func_78789_a(0.0F, 0.0F, 0.0F, 1, 1, 2);
      this.Shape11.func_78793_a(-4.0F, 22.0F, -2.0F);
      ...
      this.Shape12.func_78793_a(-1.0F, 22.0F, 2.0F);
      ...
      this.Shape13.func_78793_a(-3.0F, 22.0F, 0.0F);
      ...
      this.Shape15.func_78793_a(-2.0F, 22.0F, 1.0F);
