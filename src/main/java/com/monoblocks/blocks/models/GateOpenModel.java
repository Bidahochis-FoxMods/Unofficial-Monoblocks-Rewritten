...
public class GateOpenModel extends ModelBase {
   ...
   public GateOpenModel() {
      ...
      this.Shape4.addBox(0.0F, 0.0F, 0.0F, 1, 48, 2);
      this.Shape4.setRotationPoint(0.0F, -37.0F, -6.0F);
      this.Shape4.setTextureSize(128, 64);
      this.Shape4.mirror = true;
      this.setRotation(this.Shape4, 0.0F, 0.0F, 0.0F);
      this.Shape5 = new ModelRenderer(this, 0, 34);
      this.Shape5.addBox(0.0F, 0.0F, 0.0F, 0, 8, 8);
      ...
      this.Shape6.addBox(0.0F, -32.0F, 0.0F, 0, 8, 8);
      this.Shape6.setRotationPoint(0.0F, 2.0F, -4.0F);
