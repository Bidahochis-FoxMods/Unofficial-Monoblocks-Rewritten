...
public class ModelWorklight extends ModelBase {
   ...
   public ModelWorklight() {
      ...
      this.Shape1.func_78789_a(0.0F, 0.0F, 0.0F, 2, 64, 2);
      this.Shape1.func_78793_a(-1.0F, -40.0F, -1.0F);
      this.Shape1.func_78787_b(256, 128);
      this.Shape1.field_78809_i = true;
      this.setRotation(this.Shape1, 0.0F, 0.0F, 0.0F);
      this.Shape2 = new ModelRenderer(this, 0, 0);
      this.Shape2.func_78789_a(0.0F, 0.0F, 0.0F, 12, 1, 1);
      this.Shape2.func_78793_a(-6.0F, -36.0F, -2.0F);
      this.Shape2.func_78787_b(256, 128);
      this.Shape2.field_78809_i = true;
      this.setRotation(this.Shape2, 0.0F, 0.0F, 0.0F);
      this.Shape3 = new ModelRenderer(this, 32, 0);
      this.Shape3.func_78789_a(0.0F, 0.0F, 0.0F, 4, 4, 2);
      this.Shape3.func_78793_a(-6.0F, -41.0F, -2.0F);
      this.Shape3.func_78787_b(256, 128);
      this.Shape3.field_78809_i = true;
      this.setRotation(this.Shape3, 0.0F, 0.0F, 0.0F);
      this.Shape4 = new ModelRenderer(this, 32, 0);
      this.Shape4.func_78789_a(0.0F, 0.0F, 0.0F, 4, 4, 2);
      this.Shape4.func_78793_a(2.0F, -41.0F, -2.0F);
      this.Shape4.func_78787_b(256, 128);
      this.Shape4.field_78809_i = true;
      this.setRotation(this.Shape4, 0.0F, 0.0F, 0.0F);
      this.Shape5 = new ModelRenderer(this, 0, 0);
      this.Shape5.func_78789_a(0.0F, 0.0F, 0.0F, 1, 3, 1);
      this.Shape5.func_78793_a(2.0F, -38.0F, -1.0F);
      ...
      this.Shape6.func_78793_a(5.0F, -38.0F, -1.0F);
      ...
      this.Shape7.func_78793_a(-3.0F, -38.0F, -1.0F);
      ...
      this.Shape8.func_78793_a(-3.0F, -38.0F, -1.0F);
      ...
      this.Shape9.func_78793_a(-6.0F, -38.0F, -1.0F);
