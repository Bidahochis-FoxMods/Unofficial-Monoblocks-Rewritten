...
public class BbqModel extends ModelBase {
   ...
   public BbqModel() {
      ...
      this.Shape1.func_78789_a(0.0F, 0.0F, 0.0F, 2, 2, 1);
      this.Shape1.func_78793_a(-6.0F, 22.0F, 0.0F);
      this.Shape1.func_78787_b(64, 32);
      this.Shape1.field_78809_i = true;
      this.setRotation(this.Shape1, 0.0F, 0.0F, 0.0F);
      this.Shape2 = new ModelRenderer(this, 0, 0);
      this.Shape2.func_78789_a(0.0F, 0.0F, 0.0F, 6, 1, 1);
      this.Shape2.func_78793_a(-5.0F, 22.0F, -0.5F);
      this.Shape2.func_78787_b(64, 32);
      this.Shape2.field_78809_i = true;
      this.setRotation(this.Shape2, 0.0F, 0.0F, -0.7435626F);
      this.Shape3 = new ModelRenderer(this, 0, 0);
      this.Shape3.func_78789_a(0.0F, 0.0F, 0.0F, 4, 1, 4);
      this.Shape3.func_78793_a(-2.0F, 18.0F, -2.0F);
      ...
      this.setRotation(this.Shape4, 0.0F, -0.7807508F, 0.7435626F);
      this.Shape5 = new ModelRenderer(this, 0, 0);
      this.Shape5.func_78789_a(0.0F, 0.0F, 0.0F, 2, 2, 1);
      this.Shape5.func_78793_a(2.0F, 22.0F, 3.0F);
      this.Shape5.func_78787_b(64, 32);
      this.Shape5.field_78809_i = true;
      this.setRotation(this.Shape5, 0.0F, -0.7807556F, 0.0F);
      this.Shape6 = new ModelRenderer(this, 0, 0);
      this.Shape6.func_78789_a(0.0F, 0.0F, 0.0F, 6, 1, 1);
      this.Shape6.func_78793_a(0.0F, 18.0F, -1.0F);
      this.Shape6.func_78787_b(64, 32);
      this.Shape6.field_78809_i = true;
      this.setRotation(this.Shape6, 0.0F, 0.7807556F, 0.7435638F);
      this.Shape7 = new ModelRenderer(this, 0, 0);
      this.Shape7.func_78789_a(0.0F, 0.0F, 0.0F, 2, 2, 1);
      this.Shape7.func_78793_a(2.0F, 22.0F, -4.0F);
      this.Shape7.func_78787_b(64, 32);
      this.Shape7.field_78809_i = true;
      this.setRotation(this.Shape7, 0.0F, 0.7807556F, 0.0F);
      this.Shape8 = new ModelRenderer(this, 0, 0);
      this.Shape8.func_78789_a(0.0F, 0.0F, 0.0F, 4, 2, 1);
      ...
      this.Shape9.func_78793_a(1.4F, 16.0F, 2.1F);
      ...
      this.Shape14.func_78793_a(-2.9F, 16.0F, -2.1F);
      ...
      this.Shape15.func_78793_a(1.4F, 16.0F, -2.1F);
