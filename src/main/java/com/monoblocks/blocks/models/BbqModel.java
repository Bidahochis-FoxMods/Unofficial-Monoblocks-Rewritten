...
public class BbqModel extends ModelBase {
   ...
   public BbqModel() {
      ...
      this.Shape14.setRotationPoint(-2.9F, 16.0F, -2.1F);
      ...
      this.Shape15.setRotationPoint(1.4F, 16.0F, -2.1F);
