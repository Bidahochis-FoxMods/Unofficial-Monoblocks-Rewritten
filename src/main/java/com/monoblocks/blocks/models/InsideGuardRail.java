...
public class InsideGuardRail extends ModelBase {
   ...
   public InsideGuardRail() {
      ...
      this.Shape1.func_78793_a(4.0F, 18.0F, -3.0F);
      this.Shape1.func_78787_b(64, 32);
      this.Shape1.field_78809_i = true;
      this.setRotation(this.Shape1, 0.0F, 0.0F, 0.0F);
      this.Shape2 = new ModelRenderer(this, 0, 0);
      this.Shape2.func_78789_a(0.0F, 0.0F, 0.0F, 2, 6, 2);
      this.Shape2.func_78793_a(-3.0F, 18.0F, 4.0F);
      this.Shape2.func_78787_b(64, 32);
      this.Shape2.field_78809_i = true;
      this.setRotation(this.Shape2, 0.0F, 0.0F, 0.0F);
      this.Shape3 = new ModelRenderer(this, 0, 15);
      this.Shape3.func_78789_a(0.0F, 0.0F, 0.0F, 1, 1, 8);
      this.Shape3.func_78793_a(-0.3F, 18.0F, 0.0F);
      ...
      this.Shape4.func_78789_a(0.0F, 0.0F, 0.0F, 1, 2, 8);
      this.Shape4.func_78793_a(-1.0F, 19.0F, 0.0F);
      this.Shape4.func_78787_b(64, 32);
      this.Shape4.field_78809_i = true;
      this.setRotation(this.Shape4, 0.0F, 0.0F, 0.0F);
      this.Shape5 = new ModelRenderer(this, 0, 15);
      this.Shape5.func_78789_a(0.0F, 0.0F, 0.0F, 1, 1, 8);
      this.Shape5.func_78793_a(-0.3F, 20.0F, 0.0F);
      ...
      this.Shape6.func_78789_a(0.0F, 0.0F, 0.0F, 8, 2, 1);
      this.Shape6.func_78793_a(0.0F, 19.0F, -1.0F);
      this.Shape6.func_78787_b(64, 32);
      this.Shape6.field_78809_i = true;
      this.setRotation(this.Shape6, 0.0F, 0.0F, 0.0F);
      this.Shape7 = new ModelRenderer(this, 0, 23);
      this.Shape7.func_78789_a(0.0F, 0.0F, 0.0F, 8, 1, 1);
      this.Shape7.func_78793_a(0.0F, 18.7F, -1.033333F);
      ...
      this.Shape8.func_78789_a(0.0F, 0.0F, 0.0F, 8, 1, 1);
      this.Shape8.func_78793_a(0.0F, 20.7F, -1.0F);
