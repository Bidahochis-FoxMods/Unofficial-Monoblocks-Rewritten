...
public class InsulatorModel2 extends ModelBase {
   ...
   public InsulatorModel2() {
      ...
      this.Shape2.func_78793_a(-16.0F, 11.0F, -3.0F);
      ...
      this.Shape4.func_78793_a(7.0F, 11.7F, -2.9F);
      ...
      this.Shape5.func_78789_a(0.0F, 0.0F, 0.0F, 2, 6, 2);
      this.Shape5.func_78793_a(-1.0F, 5.0F, 1.0F);
      ...
      this.Shape6.func_78793_a(-15.0F, 7.0F, -3.0F);
      this.Shape6.func_78787_b(128, 64);
      this.Shape6.field_78809_i = true;
      this.setRotation(this.Shape6, 0.0F, 0.0F, 0.0F);
      this.Shape7 = new ModelRenderer(this, 75, 0);
      this.Shape7.func_78789_a(0.0F, 0.0F, 0.0F, 1, 4, 1);
      this.Shape7.func_78793_a(14.0F, 7.0F, -3.0F);
      ...
      this.Shape8.func_78793_a(-0.5F, 0.0F, 1.5F);
      this.Shape8.func_78787_b(128, 64);
      this.Shape8.field_78809_i = true;
      this.setRotation(this.Shape8, 0.0F, 0.0F, 0.0F);
      this.Shape9 = new ModelRenderer(this, 17, 5);
      this.Shape9.func_78789_a(0.0F, 0.0F, 0.0F, 4, 1, 4);
      this.Shape9.func_78793_a(-2.0F, 0.0F, 0.0F);
      this.Shape9.func_78787_b(128, 64);
      this.Shape9.field_78809_i = true;
      this.setRotation(this.Shape9, 0.0F, 0.0F, 0.0F);
      this.Shape10 = new ModelRenderer(this, 17, 5);
      this.Shape10.func_78789_a(0.0F, 0.0F, 0.0F, 4, 1, 4);
      this.Shape10.func_78793_a(12.5F, 7.0F, -4.5F);
      this.Shape10.func_78787_b(128, 64);
      this.Shape10.field_78809_i = true;
      this.setRotation(this.Shape10, 0.0F, 0.0F, 0.0F);
      this.Shape11 = new ModelRenderer(this, 17, 5);
      this.Shape11.func_78789_a(0.0F, 0.0F, 0.0F, 4, 1, 4);
      this.Shape11.func_78793_a(-16.5F, 7.0F, -4.5F);
      this.Shape11.func_78787_b(128, 64);
      this.Shape11.field_78809_i = true;
      this.setRotation(this.Shape11, 0.0F, 0.0F, 0.0F);
      this.Shape12 = new ModelRenderer(this, 17, 5);
      this.Shape12.func_78789_a(0.0F, 0.0F, 0.0F, 3, 1, 3);
      this.Shape12.func_78793_a(-16.0F, 8.5F, -4.0F);
      this.Shape12.func_78787_b(128, 64);
      this.Shape12.field_78809_i = true;
      this.setRotation(this.Shape12, 0.0F, 0.0F, 0.0F);
      this.Shape13 = new ModelRenderer(this, 17, 5);
      this.Shape13.func_78789_a(0.0F, 0.0F, 0.0F, 3, 1, 3);
      this.Shape13.func_78793_a(13.0F, 8.5F, -4.0F);
      this.Shape13.func_78787_b(128, 64);
      this.Shape13.field_78809_i = true;
      this.setRotation(this.Shape13, 0.0F, 0.0F, 0.0F);
      this.Shape14 = new ModelRenderer(this, 17, 5);
      this.Shape14.func_78789_a(0.0F, 0.0F, 0.0F, 2, 3, 2);
      this.Shape14.func_78793_a(13.5F, 7.5F, -3.5F);
      this.Shape14.func_78787_b(128, 64);
      this.Shape14.field_78809_i = true;
      this.setRotation(this.Shape14, 0.0F, 0.0F, 0.0F);
      this.Shape15 = new ModelRenderer(this, 17, 5);
      this.Shape15.func_78789_a(0.0F, 0.0F, 0.0F, 2, 3, 2);
      this.Shape15.func_78793_a(-15.5F, 7.5F, -3.5F);
      this.Shape15.func_78787_b(128, 64);
      this.Shape15.field_78809_i = true;
      this.setRotation(this.Shape15, 0.0F, 0.0F, 0.0F);
      this.Shape16 = new ModelRenderer(this, 17, 5);
      this.Shape16.func_78789_a(0.0F, 0.0F, 0.0F, 3, 1, 3);
      this.Shape16.func_78793_a(-1.5F, 1.5F, 0.5F);
      this.Shape16.func_78787_b(128, 64);
      this.Shape16.field_78809_i = true;
      this.setRotation(this.Shape16, 0.0F, 0.0F, 0.0F);
      this.Shape17 = new ModelRenderer(this, 17, 5);
      this.Shape17.func_78789_a(0.0F, 0.0F, 0.0F, 2, 3, 2);
      this.Shape17.func_78793_a(-1.0F, 0.5F, 1.0F);
