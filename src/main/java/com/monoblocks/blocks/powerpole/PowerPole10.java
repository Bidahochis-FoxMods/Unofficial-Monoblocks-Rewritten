...
public class PowerPole10 extends BlockContainer {
   public PowerPole10() {
      super(Material.wood);
      this.setCreativeTab(Monoblocks.monoblocksTab);
      this.setHardness(2.0F);
      this.setBlockBounds(0.34F, 0.0F, 0.34F, 0.66F, 1.0F, 0.66F);
      this.setBlockName("powerpole10");
      this.func_149672_a(field_149777_j);
   }

   @SideOnly(Side.CLIENT)
   public void func_149651_a(IIconRegister iconRegister) {
      this.blockIcon = iconRegister.registerIcon("monoblocks:powerpole10");
   }
   ...
   public TileEntity func_149915_a(World world, int meta) {
      return new TileEntityPowerPole10();
   }
