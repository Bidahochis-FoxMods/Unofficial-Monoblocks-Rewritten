...
public class StoneChest extends BlockChest {
   ...
   public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_) {
      ...
      if (p_149689_6_.hasDisplayName()) {
         ((TileEntityStoneChest)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_145976_a(p_149689_6_.getDisplayName());
      }
   ...
   public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_) {
      ...
      TileEntityStoneChest tileentitychest = (TileEntityStoneChest)p_149695_1_.getTileEntity(p_149695_2_, p_149695_3_, p_149695_4_);
   ...
   public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_) {
      TileEntityStoneChest tileentitychest = (TileEntityStoneChest)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);
      if (tileentitychest != null) {
   ...
   public IInventory func_149951_m(World p_149951_1_, int p_149951_2_, int p_149951_3_, int p_149951_4_) {
      Object object = (TileEntityStoneChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_);
      if (object == null) {
         return null;
         ...
         return null;
      } else if (p_149951_1_.getBlock(p_149951_2_ - 1, p_149951_3_, p_149951_4_) == this && (p_149951_1_.isSideSolid(p_149951_2_ - 1, p_149951_3_ + 1, p_149951_4_, ForgeDirection.DOWN) || func_149953_o(p_149951_1_, p_149951_2_ - 1, p_149951_3_, p_149951_4_))) {
         return null;
      } else if (p_149951_1_.getBlock(p_149951_2_ + 1, p_149951_3_, p_149951_4_) == this && (p_149951_1_.isSideSolid(p_149951_2_ + 1, p_149951_3_ + 1, p_149951_4_, ForgeDirection.DOWN) || func_149953_o(p_149951_1_, p_149951_2_ + 1, p_149951_3_, p_149951_4_))) {
         return null;
      } else if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ - 1) != this || !p_149951_1_.isSideSolid(p_149951_2_, p_149951_3_ + 1, p_149951_4_ - 1, ForgeDirection.DOWN) && !func_149953_o(p_149951_1_, p_149951_2_, p_149951_3_, p_149951_4_ - 1)) {
         if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ + 1) != this || !p_149951_1_.isSideSolid(p_149951_2_, p_149951_3_ + 1, p_149951_4_ + 1, ForgeDirection.DOWN) && !func_149953_o(p_149951_1_, p_149951_2_, p_149951_3_, p_149951_4_ + 1)) {
            if (p_149951_1_.getBlock(p_149951_2_ - 1, p_149951_3_, p_149951_4_) == this) {
               object = new InventoryLargeChest("Large Stone Chest", (TileEntityStoneChest)p_149951_1_.getTileEntity(p_149951_2_ - 1, p_149951_3_, p_149951_4_), (IInventory)object);
            }

            if (p_149951_1_.getBlock(p_149951_2_ + 1, p_149951_3_, p_149951_4_) == this) {
               object = new InventoryLargeChest("Large Stone Chest", (IInventory)object, (TileEntityStoneChest)p_149951_1_.getTileEntity(p_149951_2_ + 1, p_149951_3_, p_149951_4_));
            }

            if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ - 1) == this) {
               object = new InventoryLargeChest("Large Stone Chest", (TileEntityStoneChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ - 1), (IInventory)object);
            }

            if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ + 1) == this) {
               object = new InventoryLargeChest("Large Stone Chest", (IInventory)object, (TileEntityStoneChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ + 1));
            }
