...
public class StoplightStickStraightArrow extends BlockContainer implements IFoxBlocksScrollingBlock {
   public StoplightStickStraightArrow() {
      super(Material.iron);
      this.setStepSound(Block.soundTypeMetal);
      this.setCreativeTab(Monoblocks.monoblocksTab);
      this.setHardness(2.0F);
      this.setLightLevel(0.5F);
      this.setBlockName("trafficlightstickstraightarrow");
   }
   ...
   public TileEntity createNewTileEntity(World world, int meta) {
      return new TileEntityTrafficLightStickStraightArrow();
   }
