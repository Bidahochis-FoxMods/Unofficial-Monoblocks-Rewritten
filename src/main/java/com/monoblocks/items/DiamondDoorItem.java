...
public class DiamondDoorItem extends Item {
   public IIcon[] icons;

   public DiamondDoorItem() {
      this.field_77777_bU = 64;
      this.func_77637_a(Monoblocks.monoblocksTab);
      this.func_77655_b("diamonddoor");
      this.func_111206_d("monoblocks:diamonddoor");
   }
