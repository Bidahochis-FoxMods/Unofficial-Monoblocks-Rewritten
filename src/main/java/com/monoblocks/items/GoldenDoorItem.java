...
public class GoldenDoorItem extends Item {
   public IIcon[] icons;

   public GoldenDoorItem() {
      this.maxStackSize = 64;
      this.setCreativeTab(Monoblocks.monoblocksTab);
      this.setUnlocalizedName("goldendoor");
      this.setTextureName("monoblocks:goldendoor");
   }
